...
import com.project.loveindp.dal.ShopModelMapper;
...
import com.project.loveindp.recommend.RecommencSortService;
import com.project.loveindp.recommend.RecommendService;
...
public class ShopServiceImpl implements ShopService {
    ...
    public List<ShopModel> recommend(BigDecimal longitude, BigDecimal latitude) {
        ...
        List<Integer> shopIdList = recommendService.recall(463);//可以根据登陆态，这里暂时写死
        shopIdList = recommencSortService.sort(shopIdList, 463);
            for (int i : shopIdList) {
                System.out.println("shopIdList: "  + i);
            }
...
//        shopModelList.forEach(shopModel -> {    // 聚合信息
//            shopModel.setSellerModel(sellerService.get(shopModel.getSellerId()));
//            shopModel.setCategoryModel(categoryService.get(shopModel.getCategoryId()));
//        });
        return shopModelList;
